angular.module('MuscleMan').controller('MainCtrl', ['$scope', '$location', 'socket', 'User', 'LS', 'MSG', 'notify',
	function($scope, $location, socket, User, LS, MSG, notify) {
		/**
		 * Я, короче, дико извиняюсь, но в своё оправдание скажу что весь код
		 * это результат отсутствия ТЗ и нехватки времени, а также финансов
		 * доблестного заказчика. Советую не лезть в эти дебри, сэкономите нервы и время
		 * лучше поищите другой, нормальный проект, а здесь ловить кроме говнокода нечего...
		 * 
		 * С уважением, m0sk1t.
		 */
		$scope.meta = {
