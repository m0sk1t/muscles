            ...
            <div class="ya-grid-4-5">
                ...
                <div class="ya-media-page__gallery">
                    <h2 class="ya-media-page__title ya-relative">
                        ...
                        <span class="ya-albums__create-btn" ngf-multiple="true" ngf-pattern="'image/*'" ngf-drop="upload_files($files)" ngf-drag-over-class="'dragover'" ngf-select="upload_files($files)" ng-if="options.user._id === options.userid">						</span>
                    </h2>
                    <div class="ya-photos ya-photos_profile">
