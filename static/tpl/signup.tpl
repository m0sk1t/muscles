		...
		<div class="ya-row">
			<div class="grid-1-1">
				<div class="ya-sign-form">
					...
					<form ng-submit="signup()" class="ya-form ya-form_wide ya-sign-form__form">
						...
						<div class="ya-form__input ya-input ya-input_inline">
							<div class="ya-clearfix ya-center">
								<button class="ya-btn ya-btn_secondary ya-btn_inline ya-sign-form__submit" type="submit">Зарегистрироваться</button>
							</div>
						</div>
						<div class="ya-center">
							Или
