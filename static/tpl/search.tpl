					...
					<div class="ya-form ya-form_wide">
							...
							<div class="ya-clearfix">
								...
								<div class="ya-input__input">
									<div class="ya-input__field-wrapper">
										<input id="ya-name" placeholder="Имя" class="ya-input__field" type="text" ng-model="search.name" />
									</div>
								</div>
							</div>
						</div>
						<div class="ya-form__input ya-input ya-input_inline">
							<div class="ya-clearfix">
								...
								<div class="ya-input__input">
									<div class="ya-input__field-wrapper">
										<input id="ya-name" placeholder="Фамилия" class="ya-input__field" type="text" ng-model="search.surname" />
									</div>
								</div>
							</div>
						</div>
